...
**CORE** - это минималистичная 3D Tower Defense игра, вдохновленная эстетикой TRON. Игроки защищают центральный куб от нападающих вражеских кубов, размещая башни в трехмерном пространстве.

### ✨ Основные Особенности

- **🌐 3D Пространство**: Полностью трехмерная игровая среда
- **⚡ TRON Эстетика**: Неоновые wireframe объекты на черном фоне
...
- **[MVP_ROADMAP](WIKI/Implementation_Roadmap.md)** - MVP RoadMap
